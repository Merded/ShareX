...
namespace ShareX.HelpersLib
{
    ...
    public class NameParser
    {
        ...
        public string Parse(string pattern)
        {
            ...
            result = result.ReplaceAll(CodeMenuEntryFilename.guidv7.ToPrefixString().ToLowerInvariant(), () => Guid.CreateVersion7().ToString().ToLowerInvariant());
            result = result.ReplaceAll(CodeMenuEntryFilename.guidv7.ToPrefixString().ToUpperInvariant(), () => Guid.CreateVersion7().ToString().ToUpperInvariant());
